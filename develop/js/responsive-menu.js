/**
 * Make the menu accessible and responsive.
 *
 * @since 0.1.0
 *
 * @author StudioPress
...
(function (document, $) {
	...
	var genesisMenuParams = typeof generico_menu_params === 'undefined' ? '' : generico_menu_params,
	...
	genesisMenu.init = function () {
		...
		var subMenuIconClass = typeof genesisMenuParams.subMenuIconClass !== 'undefined' ? genesisMenuParams.subMenuIconClass : '';
		var toggleButtons = {
			menu: $('<button />', {
			...
			submenu: $(
				...
				.append(genesisMenuParams.subMenu)
		};
